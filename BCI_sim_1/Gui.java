...
public class Gui extends JFrame implements ActionListener{
	...
	View.Expressions expressivePanel=new View.Expressions(dataGenerator);
	...
	public Gui() throws IOException { 
		...
		btnNewButton.setIcon(new ImageIcon(Gui.class.getResource("/Core/play.jpg")));
		...
		brainLabel.setIcon(new ImageIcon(Gui.class.getResource("/Core/brain.jpg")));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == btnNewButton) {
			if (btnNewButton.getToolTipText().compareTo("Start") == 0) {
				...
				btnNewButton.setIcon(new ImageIcon(Gui.class.getResource("/Core/stop2.jpeg")));
